 ...
 */
public class RadarController extends Controller {

    public RadarController(BackAsFrontRobot2 robot, ControlManager manager) {
        super(manager, robot);
    }
    ...
    public boolean acquire() {
        if (manager.isRadarUsed())
            return false;
        manager.acquireRadar();
        return true;
    }

    @Override
    public void release() {
        manager.releaseRadar();
    }
}
