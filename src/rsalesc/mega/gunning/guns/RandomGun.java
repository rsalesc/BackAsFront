 ...
 */
public class RandomGun extends AutomaticGun {
    @Override
    public StorageNamespace getStorageNamespace() {
        return getGlobalStorage().namespace("rng");
    }

    @Override
    public String getGunName() {
        return "Random GF Gun";
    }
    ...
    public GeneratedAngle[] generateFiringAngles(EnemyLog enemyLog, double power) {
        ...
        double gf = Math.random() * 2 - 1;

        return new GeneratedAngle[]{new GeneratedAngle(1.0, f.getAngle(gf), f.distance)};
    }
}
