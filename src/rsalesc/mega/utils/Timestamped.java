 ...
 */
public class Timestamped implements Comparable<Timestamped> {
    public final BattleTime battleTime;

    public Timestamped(BattleTime battleTime) {
    ...
    public int getRound() {
        return battleTime.getRound();
    }

    @Override
    public int compareTo(Timestamped o) {
        return battleTime.compareTo(o.battleTime);
    }
}
